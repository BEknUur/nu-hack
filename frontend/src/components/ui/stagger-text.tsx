...
import { type HTMLMotionProps, type Transition, motion, useInView } from 'framer-motion';
...
function Word({ word, transition = transitionConfig, direction = 'bottom' }: WordProps) {
  const characters = word.split('');
  return (
    <span className="inline-block text-nowrap align-top overflow-hidden">
